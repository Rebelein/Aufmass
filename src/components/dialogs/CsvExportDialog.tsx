        ...
        <div className="space-y-4 py-4">
          ...
          <div className="space-y-2">
            ...
            <Button
              ...
              variant="outline"
              className="w-full justify-start gap-3 border-white/10 bg-white/5 text-white hover:bg-white/10 h-12"
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-background px-2 text-white/30">Einzelne Lieferanten</span>
            </div>
          </div>
          ...
          <div className="max-h-[300px] overflow-y-auto space-y-2 pr-2 custom-scrollbar">
            {suppliers.map((supplier) => (
              <Button
                ...
                variant="ghost"
                className="w-full justify-start gap-3 text-white/70 hover:text-white hover:bg-emerald-500/10 h-11 px-3 border border-transparent hover:border-emerald-500/20"
              >
            ...
            {suppliers.length === 0 && (
              <p className="text-center py-4 text-white/20 text-sm">Keine Artikel gefunden</p>
            )}
          </div>
        </div>
        
        <DialogFooter>
          <Button onClick={onClose} variant="ghost" className="text-white/50">
            Schließen
          </Button>
        </DialogFooter>
      </DialogContent>
